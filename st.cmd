...
epicsEnvSet("PREFIX", "BL15:PILATUS1M:")
...
drvAsynIPPortConfigure("camserver","192.0.2.40:41234")
...
#dbpf $(PREFIX)ImageMode           0
#dbpf $(PREFIX)AutoSave            1
#dbpf $(PREFIX)ReadTiffTimeout     5
#dbpf $(PREFIX)FilePath            "/home/det/images/bluetest"
#dbpf $(PREFIX)FileName            "robert1M"
#dbpf $(PREFIX)FileTemplate        "%s%s_%03d.tif"
#dbpf $(PREFIX)AutoIncrement       1
#dbpf $(PREFIX)AcquirePeriod     0.5
#dbpf $(PREFIX)AcquireTime       0.5
#dbpf $(PREFIX)ImageFileTmot       3
